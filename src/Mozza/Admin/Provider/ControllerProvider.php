...
namespace Mozza\Admin\Provider;
...
use Mozza\Admin\Controller as AdminController;
...
class ControllerProvider implements ServiceProviderInterface, ControllerProviderInterface {
    ...
    public function register(Application $app) {
        ...
        # The view namespace
        $app['twig.loader.filesystem']->addPath($app['environment']->getSrcdir() . '/Mozza/Admin/Resources/views', 'MozzaAdmin');
