...
use Pulpy\Core\Entity\SystemStatus,
    Pulpy\Core\Exception\MaintenanceNeeded\SystemStatusMissingMaintenanceNeededException;
...
class SystemStatusService {
    ...
    public function __construct(EntityManager $em) {
        ...
        $results = $this->em->getRepository('Pulpy\Core\Entity\SystemStatus')->findAll();
