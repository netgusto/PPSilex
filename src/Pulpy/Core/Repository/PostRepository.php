...
namespace Pulpy\Core\Repository;

use Symfony\Component\Finder\Finder;

use Doctrine\ORM\EntityManager;

use Pulpy\Core\Services\PostFile\PostFileRepositoryService,
...
class PostRepository {
    ...
    public function findOneBySlug($slug) {
        return $this->em->getRepository('Pulpy\Core\Entity\Post')->findOneBySlug($slug);
    }

    public function qb_findAllPublished() {
        return $this->em->createQueryBuilder()
            ->select('p')
            ->from('Pulpy\Core\Entity\Post', 'p')
    ...
    public function deleteAll() {
        $q = $this->em->createQuery('DELETE FROM Pulpy\Core\Entity\Post');
        $q->execute();
    }

    public function deleteOneBySlug($slug) {
        $q = $this->em->createQuery('DELETE FROM Pulpy\Core\Entity\Post p where p.slug = :slug');
